...
def plot(args):
    ...
    workspace = '../scripts/workspaces/audioset_tagging/'
    select = args.select
    
    classes_num = config.classes_num
    max_plot_iteration = 100000
    ...
    def _load_metrics(filename, sample_rate, window_size, hop_size, mel_bins, fmin, 
        ...
        statistics_path = os.path.join(workspace, 'statistics', filename, 
            ...
            sample_rate, window_size, hop_size, mel_bins, fmin, fmax), 
            'data_type={}'.format(data_type), model_type, 
            'loss_type={}'.format(loss_type), 'balanced=balanced',
            'augmentation=mixup', 'batch_size={}'.format(batch_size),
            'statistics.pkl')
    ...
    if select == '1_cnn13':
        ...
        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn13_gwrp', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='b', alpha=bal_alpha)
        line, = ax.plot(test_map, label='cnn13_gmpgapgwrp', color='b', alpha=test_alpha)
        lines.append(line)

        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn13_att', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='g', alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'ResNet18', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='b', alpha=bal_alpha)
        line, = ax.plot(test_map, label='ResNet18', color='b', alpha=test_alpha)
        lines.append(line)

        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'ResNet34', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='k', alpha=bal_alpha)
        line, = ax.plot(test_map, label='resnet34', color='k', alpha=test_alpha)
        lines.append(line)

        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'ResNet50', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='c', alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'DenseNet121', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='b', alpha=bal_alpha)
        line, = ax.plot(test_map, label='densenet121', color='b', alpha=test_alpha)
        lines.append(line)

        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'DenseNet201', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='g', alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn5', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='b', alpha=bal_alpha)
        line, = ax.plot(test_map, label='cnn5', color='b', alpha=test_alpha)
        lines.append(line)

        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn9', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='g', alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            500, 64, 50, 14000, 'balanced_train', 'Cnn13', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='b', alpha=bal_alpha)
        line, = ax.plot(test_map, label='cnn13_hop500', color='b', alpha=test_alpha)
        lines.append(line)

        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            640, 64, 50, 14000, 'balanced_train', 'Cnn13', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='g', alpha=bal_alpha)
        line, = ax.plot(test_map, label='cnn13_hop640', color='g', alpha=test_alpha)
        lines.append(line)

        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            1000, 64, 50, 14000, 'balanced_train', 'Cnn13', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='k', alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn13_emb32', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='b', alpha=bal_alpha)
        line, = ax.plot(test_map, label='cnn13_emb32', color='b', alpha=test_alpha)
        lines.append(line)

        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn13_emb128', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='g', alpha=bal_alpha)
        line, = ax.plot(test_map, label='cnn13_emb128', color='g', alpha=test_alpha)
        lines.append(line)

        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn13_emb512', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='k', alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'MobileNetV1', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='b', alpha=bal_alpha)
        line, = ax.plot(test_map, label='mobilenetv1', color='b', alpha=test_alpha)
        lines.append(line)

        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'MobileNetV2', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='g', alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn1d_LeeNet', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='g', alpha=bal_alpha)
        line, = ax.plot(test_map, label='Cnn1d_LeeNet', color='g', alpha=test_alpha)
        lines.append(line)

        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn1d_LeeNet18', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='b', alpha=bal_alpha)
        line, = ax.plot(test_map, label='Cnn1d_LeeNet18', color='b', alpha=test_alpha)
        lines.append(line)

        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn1d_DaiNet', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='k', alpha=bal_alpha)
        line, = ax.plot(test_map, label='Cnn1d_DaiNet', color='k', alpha=test_alpha)
        lines.append(line)

        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn1d_ResNet34', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='c', alpha=bal_alpha)
        line, = ax.plot(test_map, label='Cnn1d_ResNet34', color='c', alpha=test_alpha)
        lines.append(line)

        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn1d_ResNet50', 'clip_bce', 'balanced', 'mixup', 32)
        ...
        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn13_SpAndWav', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='b', alpha=bal_alpha)
        line, = ax.plot(test_map, label='Cnn13_SpAndWav', color='b', alpha=test_alpha)
        lines.append(line)

        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn13_WavCnn2d', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='g', alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn13_DecisionLevelMax', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='b', alpha=bal_alpha)
        line, = ax.plot(test_map, label='Cnn13_DecisionLevelMax', color='b', alpha=test_alpha)
        lines.append(line)

        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn13_DecisionLevelAvg', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='g', alpha=bal_alpha)
        line, = ax.plot(test_map, label='Cnn13_DecisionLevelAvg', color='g', alpha=test_alpha)
        lines.append(line)

        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn13_DecisionLevelAtt', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='k', alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn13_Transformer1', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='g', alpha=bal_alpha)
        line, = ax.plot(test_map, label='Cnn13_Transformer1', color='g', alpha=test_alpha)
        lines.append(line)

        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn13_Transformer3', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='b', alpha=bal_alpha)
        line, = ax.plot(test_map, label='Cnn13_Transformer3', color='b', alpha=test_alpha)
        lines.append(line)

        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn13_Transformer6', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='k', alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn14_16k', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='g', alpha=bal_alpha)
        line, = ax.plot(test_map, label='cnn14_16k', color='g', alpha=test_alpha)
        lines.append(line)

        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn14_8k', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='b', alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn14_mixup_time_domain', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='b', alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'partial_0.9_balanced_train', 'Cnn14', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='b', alpha=bal_alpha)
        line, = ax.plot(test_map, label='cnn14,partial_0.9', color='b', alpha=test_alpha)
        lines.append(line)

        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'partial_0.8_balanced_train', 'Cnn14', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='g', alpha=bal_alpha)
        line, = ax.plot(test_map, label='cnn14,partial_0.8', color='g', alpha=test_alpha)
        lines.append(line)

        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'partial_0.7_balanced_train', 'Cnn14', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='k', alpha=bal_alpha)
        line, = ax.plot(test_map, label='cnn14,partial_0.7', color='k', alpha=test_alpha)
        lines.append(line)

        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'partial_0.5_balanced_train', 'Cnn14', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='m', alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 32, 50, 14000, 'balanced_train', 'Cnn14_mel32', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='r', alpha=bal_alpha)
        line, = ax.plot(test_map, label='cnn14_mel32', color='b', alpha=test_alpha)
        lines.append(line)

        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 128, 50, 14000, 'balanced_train', 'Cnn14_mel128', 'clip_bce', 'balanced', 'mixup', 32)
        line, = ax.plot(bal_map, color='r', alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn14', 'clip_bce', 'alternate', 'mixup', 32)
        line, = ax.plot(bal_map, color='b', alpha=bal_alpha)
        ...
        (bal_map, test_map, legend) = _load_metrics('main', 32000, 1024, 
                320, 64, 50, 14000, 'balanced_train', 'Cnn13_no_specaug', 'clip_bce', 'none', 'none', 32)
        line, = ax.plot(bal_map, color='c', alpha=bal_alpha)
...
def table_values(args):
    ...
    if select == 'cnn13':
        ...
        _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn13', 'clip_bce', 'balanced', 'mixup', 32, iteration)

    elif select == 'cnn5':
        iteration = 440000
        _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn5', 'clip_bce', 'balanced', 'mixup', 32, iteration)

    elif select == 'cnn9':
        iteration = 440000
        _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn9', 'clip_bce', 'balanced', 'mixup', 32, iteration)

    elif select == 'cnn13_decisionlevelmax':
        iteration = 400000
        _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn13_DecisionLevelMax', 'clip_bce', 'balanced', 'mixup', 32, iteration)
    
    elif select == 'cnn13_decisionlevelavg':
        iteration = 600000
        _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn13_DecisionLevelAvg', 'clip_bce', 'balanced', 'mixup', 32, iteration)

    elif select == 'cnn13_decisionlevelatt':
        iteration = 600000
        _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn13_DecisionLevelAtt', 'clip_bce', 'balanced', 'mixup', 32, iteration)

    elif select == 'cnn13_emb32':
        iteration = 560000
        _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn13_emb32', 'clip_bce', 'balanced', 'mixup', 32, iteration)

    elif select == 'cnn13_emb128':
        iteration = 560000
        _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn13_emb128', 'clip_bce', 'balanced', 'mixup', 32, iteration)

    elif select == 'cnn13_emb512':
        iteration = 440000
        _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn13_emb512', 'clip_bce', 'balanced', 'mixup', 32, iteration)

    elif select == 'cnn13_hop500':
        iteration = 440000
        _load_metrics('main', 32000, 1024, 
            500, 64, 50, 14000, 'balanced_train', 'Cnn13', 'clip_bce', 'balanced', 'mixup', 32, iteration)

    elif select == 'cnn13_hop640':
        iteration = 440000
        _load_metrics('main', 32000, 1024, 
            640, 64, 50, 14000, 'balanced_train', 'Cnn13', 'clip_bce', 'balanced', 'mixup', 32, iteration)

    elif select == 'cnn13_hop1000':
        iteration = 540000
        _load_metrics('main', 32000, 1024, 
            1000, 64, 50, 14000, 'balanced_train', 'Cnn13', 'clip_bce', 'balanced', 'mixup', 32, iteration)

    elif select == 'mobilenetv1':
        iteration = 560000
        _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'MobileNetV1', 'clip_bce', 'balanced', 'mixup', 32, iteration)

    elif select == 'mobilenetv2':
        iteration = 560000
        _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'MobileNetV2', 'clip_bce', 'balanced', 'mixup', 32, iteration)

    elif select == 'resnet18':
        iteration = 600000
        _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'ResNet18', 'clip_bce', 'balanced', 'mixup', 32, iteration)

    elif select == 'resnet34':
        iteration = 600000
        _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'ResNet34', 'clip_bce', 'balanced', 'mixup', 32, iteration)

    elif select == 'resnet50':
        iteration = 600000
        _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'ResNet50', 'clip_bce', 'balanced', 'mixup', 32, iteration)

    elif select == 'dainet':
        iteration = 600000
        _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn1d_DaiNet', 'clip_bce', 'balanced', 'mixup', 32, iteration)

    elif select == 'leenet':
        iteration = 540000
        _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn1d_LeeNet', 'clip_bce', 'balanced', 'mixup', 32, iteration)

    elif select == 'leenet18':
        iteration = 440000
        _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn1d_LeeNet18', 'clip_bce', 'balanced', 'mixup', 32, iteration)

    elif select == 'resnet34_1d':
        iteration = 500000
        _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn1d_ResNet34', 'clip_bce', 'balanced', 'mixup', 32, iteration)

    elif select == 'resnet50_1d':
        iteration = 500000
        _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn1d_ResNet50', 'clip_bce', 'balanced', 'mixup', 32, iteration)

    elif select == 'waveform_cnn2d':
        iteration = 660000
        _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn13_WavCnn2d', 'clip_bce', 'balanced', 'mixup', 32, iteration)

    elif select == 'waveform_spandwav':
        iteration = 700000
        _load_metrics('main', 32000, 1024, 
            320, 64, 50, 14000, 'balanced_train', 'Cnn13_SpAndWav', 'clip_bce', 'balanced', 'mixup', 32, iteration)
...
def summary_stats(args):
    ...
    output_dict = {
        ...
        'downloaded_balanced_training_samples': config.full_samples_per_class, 
...
def print_results(args):
    ...
    (mAP, mAUC, dprime) = _load_metrics_classwise('main', 32000, 1024, 320, 64, 50, 14000, 'balanced_train', 'Cnn14_mixup_time_domain', 'clip_bce', 'balanced', 'mixup', 32)
    ...
    # 
    (mAP, mAUC, dprime) = _load_metrics0_classwise2('main', 32000, 1024, 320, 64, 50, 14000, 'balanced_train', 'Cnn13_emb32', 'clip_bce', 'balanced', 'mixup', 32)

    (mAP, mAUC, dprime) = _load_metrics0_classwise2('main', 32000, 1024, 320, 64, 50, 14000, 'balanced_train', 'Cnn13_emb128', 'clip_bce', 'balanced', 'mixup', 32)

    # partial
    (mAP, mAUC, dprime) = _load_metrics_classwise('main', 32000, 1024, 320, 64, 50, 14000, 'partial_0.8_balanced_train', 'Cnn14', 'clip_bce', 'balanced', 'mixup', 32)

    (mAP, mAUC, dprime) = _load_metrics_classwise('main', 32000, 1024, 320, 64, 50, 14000, 'partial_0.5_balanced_train', 'Cnn14', 'clip_bce', 'balanced', 'mixup', 32)

    # Sample rate
    (mAP, mAUC, dprime) = _load_metrics_classwise('main', 32000, 1024, 320, 64, 50, 14000, 'balanced_train', 'Cnn14_16k', 'clip_bce', 'balanced', 'mixup', 32)

    (mAP, mAUC, dprime) = _load_metrics_classwise('main', 32000, 1024, 320, 64, 50, 14000, 'balanced_train', 'Cnn14_8k', 'clip_bce', 'balanced', 'mixup', 32)

    # Mel bins
    (mAP, mAUC, dprime) = _load_metrics_classwise('main', 32000, 1024, 320, 128, 50, 14000, 'balanced_train', 'Cnn14_mel128', 'clip_bce', 'balanced', 'mixup', 32)

    (mAP, mAUC, dprime) = _load_metrics_classwise('main', 32000, 1024, 320, 32, 50, 14000, 'balanced_train', 'Cnn14_mel32', 'clip_bce', 'balanced', 'mixup', 32)
