...
def plot_classwise_iteration_map(args):
    ...
    # Load statistics
    statistics_dict = pickle.load(open('paper_statistics/statistics_sr32000_window1024_hop320_mel64_fmin50_fmax14000_balanced_train_WavegramLogmelCnn_balanced_mixup_bs32.pkl', 'rb'))
...
def plot_six_figures(args):
    ...
    if True:
        ...
        # Wavegram-Logmel-CNN
        (bal_map, test_map) = load_statistics('paper_statistics/statistics_sr32000_window1024_hop320_mel64_fmin50_fmax14000_balanced_train_WavegramLogmelCnn_balanced_mixup_bs32.pkl')
        ...
        # MobileNetV1
        (bal_map, test_map) = load_statistics('paper_statistics/statistics_sr32000_window1024_hop320_mel64_fmin50_fmax14000_balanced_train_MobileNetV1_balanced_mixup_bs32.pkl')
    ...
    if True:
        ...
        (bal_map, test_map) = load_statistics('paper_statistics/statistics_sr32000_window1024_hop320_mel64_fmin50_fmax14000_balanced_train_Cnn14_balanced_mixup_timedomain_bs32.pkl')
        ...
        (bal_map, test_map) = load_statistics('paper_statistics/statistics_sr32000_window1024_hop320_mel64_fmin50_fmax14000_balanced_train_Cnn14_nobalanced_nomixup_bs32.pkl')
    ...
    if True:
        ...
        # Embedding size 128
        (bal_map, test_map) = load_statistics('paper_statistics/statistics_sr32000_window1024_hop320_mel64_fmin50_fmax14000_balanced_train_Cnn14_emb128_balanced_mixup_bs32.pkl')
        ...
        # Embedding size 32
        (bal_map, test_map) = load_statistics('paper_statistics/statistics_sr32000_window1024_hop320_mel64_fmin50_fmax14000_balanced_train_Cnn14_emb32_balanced_mixup_bs32.pkl')
    ...
    if True:
        ...
        (bal_map, test_map) = load_statistics('paper_statistics/statistics_sr32000_window1024_hop320_mel64_fmin50_fmax14000_0.8balanced_train_Cnn14_balanced_mixup_bs32.pkl')
        ...
        (bal_map, test_map) = load_statistics('paper_statistics/statistics_sr32000_window1024_hop320_mel64_fmin50_fmax14000_0.5balanced_train_Cnn14_balanced_mixup_bs32.pkl')
    ...
    if True:
        ...
        # Cnn14 + 16 kHz
        (bal_map, test_map) = load_statistics('paper_statistics/statistics_sr32000_window1024_hop320_mel64_fmin50_fmax14000_balanced_train_Cnn14_16k_balanced_mixup_bs32.pkl')
        ...
        # Cnn14 + 8 kHz
        (bal_map, test_map) = load_statistics('paper_statistics/statistics_sr32000_window1024_hop320_mel64_fmin50_fmax14000_balanced_train_Cnn14_8k_balanced_mixup_bs32.pkl')
    ...
    if True:
        ...
        # Cnn14 + 128 mel bins
        (bal_map, test_map) = load_statistics('paper_statistics/statistics_sr32000_window1024_hop320_mel128_fmin50_fmax14000_balanced_train_Cnn14_balanced_mixup_bs32.pkl')
        ...
        # Cnn14 + 32 mel bins
        (bal_map, test_map) = load_statistics('paper_statistics/statistics_sr32000_window1024_hop320_mel32_fmin50_fmax14000_balanced_train_Cnn14_balanced_mixup_bs32.pkl')
